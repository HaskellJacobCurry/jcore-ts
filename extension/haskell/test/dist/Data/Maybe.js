...
*/
var maybeStr = (Maybe_1.Maybe.Apply.lift2(function (a) { return function (b) { return (Int_1.Int.Show.show(Int_1.Int.Ring.mul(a)(b))); }; })(Maybe_1.Maybe.Just(Int_1.Int(33)))(Maybe_1.Maybe.Just(Int_1.Int(11))));
