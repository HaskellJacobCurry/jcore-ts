...
var Unit_1 = require("../../../dist/DataStructure/Data/Unit");
var Bool_1 = require("../../../dist/DataStructure/Data/Bool");
var Common_1 = require("../../../dist/Common");
({
    0: function () { return (Common_1.apply({
        lazy: (Common_1.apply(LazySequence_1.LazySequence(Int_1.Int.Ring.add(Int_1.Int(1)))(Int_1.Int(1)))(function (_) { return Common_1.apply(LazySequence_1.LazySequence.filter(Int_1.Int.odd)(_)); })(function (_) { return LazySequence_1.LazySequence.fmap(Int_1.Int.Ring.mul(Int_1.Int(3)))(_); }))
    })(function (_a) {
        var lazy = _a.lazy;
    ...
    1: function () { return (Common_1.apply({
        lazy: (Common_1.apply(LazySequence_1.LazySequence(Int_1.Int.inc)(Int_1.Int(1)))(function (_) { return Common_1.apply(LazySequence_1.LazySequence.filter(Int_1.Int.odd)(_)); })(function (_) { return Common_1.apply(LazySequence_1.LazySequence.fmap(Int_1.Int.Ring.mul(Int_1.Int(3)))(_)); })(function (_) { return (
