...
export declare type BaseIterator<T = any> = Iterator<T>;
export declare namespace BaseIterator {
    type Value<TIterator> = (TIterator extends BaseIterator<infer T> ? T : TIterator extends BidirectionalIterator<infer T> ? T : TIterator extends RandomAccessIterator<infer T> ? T : TIterator extends OutputIterator<infer T> ? T : TIterator extends MutableIterator<infer T> ? T : never);
}
