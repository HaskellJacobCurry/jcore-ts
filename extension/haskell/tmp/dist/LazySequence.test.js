...
var LazySequence_1 = require("./LazySequence");
...
({
    ...
    1: function () { return (util_1.apply({
        ...
        LazySequence_1.LazySequence.until(function (_) { return Bool_1.Bool.fromI(Int_1.Int.Ord.lt(Int_1.Int(1e6))(_)); })(_)); }))
    })(function (_a) {
        var lazy = _a.lazy;
        return (util_1.apply(LazySequence_1.LazySequence.evaluate(function (_) { return (
